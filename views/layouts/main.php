...
<div class="wrap">
    <?php
    NavBar::begin([
        'brandLabel' => 'Bussiness Solutions',
    ...
    echo Nav::widget([
        ...
        'items' => [
            ['label' => 'Admin','items' => 
              [
                 ['label' => 'Display Users', 'url' => ['/user/admin/index']],
                 '<li class="divider"></li>',
                 ['label' => 'Create Users', 'url' => ['/user/admin/create']],
             ], 'visible' => !Yii::$app->user->isGuest && Yii::$app->user->identity->isAdmin],
            
             ['label' => 'Profile','items' => 
              [
                 ['label' => 'Show Profile', 'url' => ['/user/profile']],
                 '<li class="divider"></li>',
...
<footer class="footer">
    <div class="container">
        <p class="pull-left">&copy; Bussiness Solution <?= date('Y') ?></p>
